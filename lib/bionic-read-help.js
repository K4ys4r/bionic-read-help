import { defaultSetting, setElementStyleProperties } from "./utils";

class BionicReadHelp extends HTMLParagraphElement {
  constructor() {
    super();
    this.content = "";
    this.isBionic = true;
  ...
  updateElement() {
    console.log("from web component");
    // ToolsBar
    this.innerHTML = "";
    if (this.bionicType === defaultSetting.bionicTypes.interactive) {
...
// Then can be used to extend HTML paragraph element
